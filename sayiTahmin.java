...
public class soru11 {
    ...
    public static void main(String[] args) {
        ...
        int uretilenSayi = (int) (Math.random() * 101); // o ile 100 arası sayı üretilir.100 dahil.
        int tahmin = -1 ;
        ...
        while (tahmin != uretilenSayi){
            ...
            if (tahmin == uretilenSayi){
                ...
                System.out.println("Tahmin ettiğiniz sayı çok düşük,yükseltin.");
            }
